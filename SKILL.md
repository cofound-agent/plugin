...
> This is the canonical skill content. Claude Code and Cursor plugins
> auto-discover the same content from `skills/cofound/SKILL.md`. Other MCP
> clients (Codex, Cline, Continue, ChatGPT) can paste this file's body into
> their system prompt or AGENTS.md.
